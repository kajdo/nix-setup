	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			require("telescope").setup({
				...
				--
				defaults = {
					-- kajdo trying to add a possibility to close telescope with q
					mappings = {
						-- i = { ['<c-enter>'] = 'to_fuzzy_refine' },
						i = {
							["<C-c>"] = require("telescope.actions").close, -- Close in insert mode with Ctrl + q
						},
						n = {
							["<C-c>"] = require("telescope.actions").close, -- Close in normal mode with Ctrl + q
						},
					},
				},
				-- pickers = {}
				...
				lua_ls = {
					...
					settings = {
						Lua = {
							...
							diagnostics = {
								globals = { "vim" }, -- Add Neovim globals here
